...
// import CategoriesWidget from '@plone/volto/components/manage/Widgets/CategoriesWidget';

// class CategoriesWidget extends CategoriesWidget {
//     componentDidMount() {
//         debugger;
//     }
//     render() {
 ...
 */
 ...
 /**
  * CategoriesWidget component class.
 ...
 class CategoriesWidget extends Component {
   ...
   componentDidMount() {
    ...
    const api = `https://www.outdooractive.com/api/project/${config.settings.outdooractive.projectId}/category/tree/pruned?key=${config.settings.outdooractive.apiKey}&lang=${currentLang}`;
    fetch(
        api, {
            headers: {
        ...
        // console.log(data);
        // debugger;
        // prende solo le categorie di primo livello (!)
        this.props.items.choices = data.category.map(item => {
    ...
    */
   render() {
     const choices = normalizeChoices(this.props?.items?.choices || []);
 ...
 export const CategoriesWidgetComponent = injectIntl(CategoriesWidget);
